...
JOBS = [
    {
        "manuscript": "02-ebook-reparation/ebook-reparation.md",
        "annex_marker": "# Annexes",
        "fragments": [
            "02-ebook-reparation/ext-01-reparations-avancees.md",
            "02-ebook-reparation/ext-02-montres-microsoudure-atelier.md",
        ],
    },
    {
        "manuscript": "03-ebook-flash-decodage/ebook-flash-decodage.md",
        "annex_marker": "# ANNEXE A",
        "fragments": [
            "03-ebook-flash-decodage/ext-01-marques-outils.md",
            "03-ebook-flash-decodage/ext-02-theorie-bios-juridique.md",
        ],
    },
]
